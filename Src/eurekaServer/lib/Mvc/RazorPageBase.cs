...
namespace Microsoft.AspNetCore.Mvc.Razor
{
    public abstract class RazorPageBase<TModel> : RazorPage<TModel>
    {
        ...
        public HtmlString SelectOptions(IEnumerable<SelectOption> optionList)
        {
            return this.SelectOptions((object)optionList,null);
        }


        public HtmlString SelectOptions(IEnumerable<SelectOption> optionList, string defaultText )
        {
            return this.SelectOptions((object)optionList, defaultText);
        }
        public HtmlString SelectOptions(object optionList, string defaultText )
        {
