...
namespace msgp.common.dotnetty
{
    ...
    public class CommandPPacketDecode : LengthFieldBasedFrameDecoder
    {
        ...
        public CommandPPacketDecode(int maxFrameLength, int lengthFieldOffset, int lengthFieldLength,
        ...
        protected override Object Decode(IChannelHandlerContext ctx, IByteBuffer input)
        {
            ...
            cmdMessage customMsg = null;
            if (!cmdMessage.Parse(input, out customMsg))
            {
    ...
    public class CommandPacketEncoder : MessageToByteEncoder<cmdMessage>
    {
        protected override void Encode(IChannelHandlerContext context, cmdMessage message, IByteBuffer output)
        {
            //序列化类
            IByteBuffer bb = null;
            try
